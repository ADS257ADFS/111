...
const STYLES = `
  ...
  .pr-audio-info span { color: #fff; font-weight: 445; }
  .pr-controls-group {
    background: #1e1e1e;
  ...
  .pr-gap-menu-btn {
    background: #2a2a2a;
    color: var(--ui-text-secondary, #e0e0e0);
    border: 1px solid #333;
    border-radius: 4px;
    padding: 6px 14px;
    font-size: 11px;
  ...
  .pr-gap-menu-btn:disabled {
    color: var(--ui-text-disabled, rgba(170, 170, 170, .46));
  }
  .pr-gap-menu-btn.is-danger,
  .pr-gap-menu-btn.is-danger:hover {
...
class TimelineEditor {
  ...
  showContextMenu(clientX, clientY, seg, trackType) {
    ...
    delBtn.className = "pr-gap-menu-btn is-danger";
