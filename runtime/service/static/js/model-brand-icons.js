...
(function(global){
    ...
    const RULES = [
        ...
        [/deepseek/, 'deepseek'],
        [/eleven/, 'eleven'],
        [/qwen|wan[\s\d.x-]|wanx|通义|tongyi|alibaba/, 'alibaba'],
    ...
    // 固定别名 → 一句话说明（悬停时在模型名下方上滑展示）
    const DESCS = {
        'nano banana 2 lite': '谷歌轻量图像模型，快速出图',
        'seedream 5.0 lite': '即梦轻量版，高性价比日常出图',
        'seedream 5.0 pro': '即梦旗舰版，细节与语义理解更强',
        'seedream 4.0': '即梦经典版本，稳定的综合生图',
        'seedream 4.5': '即梦升级版，构图与质感更佳',
        'gpt image2': 'OpenAI 图像模型，文字渲染出色',
        'banana 2': '谷歌新一代图像模型，编辑能力强',
        'banana pro': '谷歌专业版图像模型，画质细节拉满',
        'banana': '谷歌图像模型，自然语义修图',
        'mj v7': 'Midjourney V7，艺术风格表现力强',
        'mj v8.2': 'Midjourney 最新版，写实与美感兼具',
        'mj v8.1': 'Midjourney V8.1，风格统一度更高',
        'hailuo-02': '海螺视频模型，动作流畅自然',
        'vidu q2': 'Vidu 视频模型，人物一致性好',
        'seedance 2.0': '即梦视频模型，运镜与叙事稳定',
        'seedance 2.0 fast': '即梦快速版视频，秒级出片',
        'seedance 2.5': '即梦升级版视频，画质动态更强',
        'minimax h3': 'MiniMax 视频模型，物理表现真实',
        'kling 3.0 omni': '可灵全能版，支持多模态输入',
        'gemini omni flash': '谷歌快速视频模型，响应迅捷',
        'kling 3.0': '可灵 3.0，电影感画面表现',
        'happyhorse 1.0': '新架构视频模型，动作自然',
        'happyhorse 1.1': '升级版视频模型，细节更细腻',
        'mureka v8': 'Mureka 音乐模型，整曲生成',
        'mureka o2': 'Mureka 推理版，人声更真实',
        'seed audio 1.0': '字节音频模型，多风格配音',
        'minimax music 2.6': 'MiniMax 音乐生成，编曲完整',
        'elevenlabs v3': '顶级语音合成，情感表达丰富',
        'sonilo music': '音乐生成模型，旋律记忆点强',
        'minimax-speech-2.8-hd': '高保真语音合成，音质细腻',
        'minimax-speech-2.8-turbo': '极速语音合成，低延迟',
        'eleven v3': 'ElevenLabs 语音，多语种表现力强',
        'eleven music v3': 'ElevenLabs 音乐，人声乐器俱佳',
        'gemini 3.1 flash lite': '谷歌轻量对话模型，极速响应',
        'deepseek v4 pro': 'DeepSeek 旗舰，推理与代码能力强',
        'gemini 3.1 pro': '谷歌旗舰模型，长上下文多模态',
        'gemini 3 flash': '谷歌快速模型，日常任务首选',
        'gpt-5.6': 'OpenAI 旗舰模型，综合能力顶尖',
    };
