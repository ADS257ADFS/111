...
/* 磨砂效果直观示意（画布右下角） */
.glass-demo {
  position: absolute; right: 16px; top: 56px; z-index: 88;
  width: 210px; height: 118px; border-radius: var(--lb-r-float); overflow: hidden;
...
.glass-demo-pattern {
  ...
  background:
    repeating-linear-gradient(90deg, #ff6b9d 0 20px, #ffd166 20px 40px, #4ecdc4 40px 60px, #6c9eff 60px 80px),
    repeating-linear-gradient(0deg, rgba(0,0,0,.08) 0 12px, transparent 12px 24px);
}
.glass-demo-card {
  position: absolute; inset: 20px 14px;
  display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px;
  padding: 12px; border-radius: var(--lb-r-card);
  border: var(--lb-divider-size) solid rgba(255,255,255,.35);
  background: var(--lb-glass-bg);
  backdrop-filter: var(--lb-glass-filter); -webkit-backdrop-filter: var(--lb-glass-filter);
  font-size: var(--lb-type-compact); color: var(--lb-text); text-align: center; line-height: 1.4;
}
.glass-demo-card small { font-size: var(--lb-type-meta); color: var(--lb-text-muted); }

/* personal homepage — 不在画布中央，独立入口见 个人主页-样板.html */
...
.canvas-bg-pattern {
  ...
  background:
    radial-gradient(ellipse 280px 220px at 18% 28%, rgba(255, 120, 160, 0.38) 0%, transparent 70%),
    radial-gradient(ellipse 320px 260px at 72% 38%, rgba(80, 170, 255, 0.42) 0%, transparent 72%),
    radial-gradient(ellipse 240px 200px at 48% 72%, rgba(255, 195, 90, 0.36) 0%, transparent 68%),
    radial-gradient(ellipse 200px 180px at 85% 78%, rgba(140, 230, 170, 0.32) 0%, transparent 65%),
...
html.theme-dark .canvas-bg-pattern {
  background:
    radial-gradient(ellipse 280px 220px at 18% 28%, rgba(255, 80, 130, 0.28) 0%, transparent 70%),
    radial-gradient(ellipse 320px 260px at 72% 38%, rgba(60, 140, 255, 0.32) 0%, transparent 72%),
    radial-gradient(ellipse 240px 200px at 48% 72%, rgba(255, 170, 60, 0.26) 0%, transparent 68%),
  ...
  <div class="body-row">
    ...
    <div class="stage-wrap">
      <div class="stage">
        ...
        <div class="canvas">
          <span class="proto-label" style="top:8px;left:8px">画布直角 · 网格 22px · 底层有彩色图案</span>
