(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.promptPlaceholder": { zh: "描述你想生成或编辑的图片...", en: "Describe the image you want to generate or edit..." },
        "smart.audioPromptPlaceholder": { zh: "描述你想生成的音乐或音频...", en: "Describe the music or audio you want to generate..." },
        "smart.videoPromptPlaceholder": { zh: "描述你想生成或编辑的视频...", en: "Describe the video you want to generate or edit..." },
        ...
        "smart.regenerate": { zh: "重新生成", en: "Regenerate" },
        ...
        "smart.videoCount": { zh: "生成数量", en: "Count" },
        ...
        "smart.assetPinnedLibraryFolder": { zh: "通用文件夹", en: "General folder" },
        "smart.assetRootFolder": { zh: "根目录", en: "Root" },
        "smart.assetStoryLibrary": { zh: "选择故事资产库", en: "Story asset library" },
        "smart.assetGridSmall": { zh: "小图", en: "Small thumbnails" },
        "smart.assetGridMedium": { zh: "中图", en: "Medium thumbnails" },
        "smart.assetGridLarge": { zh: "大图", en: "Large thumbnails" },
        "smart.assetFolderCreated": { zh: "文件夹已创建", en: "Folder created" },
        "smart.assetStoryLibraryMissing": { zh: "当前故事资产库未就绪，请刷新页面或重启服务后重试", en: "Story asset library is not ready. Refresh the page or restart the service." },
        ...
        "smart.assetFolderSearch": { zh: "搜索文件夹", en: "Search folders" },
        "smart.assetFolderTreeEmpty": { zh: "还没有一级文件夹，点击「新建」开始整理。", en: "No folders yet. Click New to get started." },
        "smart.assetNoSubfolder": { zh: "还没有二级文件夹，点击右侧省略号新建。", en: "No subfolders yet. Use the menu to add one." },
        "smart.assetSelectRootFirst": { zh: "请先选中一个一级文件夹", en: "Select a top-level folder first" },
        "smart.assetDeleteChildrenFirst": { zh: "请先删除该文件夹下的二级文件夹", en: "Delete subfolders first" },
        "smart.assetDeleteFolderConfirm": { zh: "确定删除这个文件夹吗？", en: "Delete this folder?" },
        "smart.assetBackToFolders": { zh: "返回文件夹", en: "Back to folders" },
        "smart.assetToggleFolder": { zh: "展开/收起", en: "Expand/collapse" },
        "smart.assetFolderMenu": { zh: "文件夹菜单", en: "Folder menu" },
