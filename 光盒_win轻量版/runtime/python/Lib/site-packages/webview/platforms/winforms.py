    ...
    class BrowserForm(WinForms.Form):
        ...
        def WndProc(self, message):
            if (
                ...
                left = point.X < border
                # Right-edge native resize hit-testing steals the chat-dock
                # scrollbar (flush to the window edge). Right resize stays on
                # the HTML handle / corners via start_native_window_interaction.
                right = False
                top = point.Y < border
